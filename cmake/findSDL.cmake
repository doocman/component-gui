...
set(_ASP_SDL_FOUND OFF)

if (ASP_SDL_STATIC)
    set(_ASP_SDL_LIB SDL3::SDL3-static)
else ()
    set(_ASP_SDL_LIB SDL3::SDL3)
endif ()

foreach (E IN LISTS ASP_SDL_FETCH)
    if (_ASP_SDL_FOUND)
        break()
    else ()
        if (E STREQUAL "fetch")
        ...
        elseif (E STREQUAL "system")
            ...
            if (NOT TARGET ${_ASP_SDL_LIB})
                ...
                set(ASP_SDL_STATIC SDL3::SDL3)
            endif ()
        else ()
            message(SEND_ERROR "Unrecognized ASP_SDL_FETCH option '${E}'")
            break()
        endif ()
    endif ()
endforeach ()
